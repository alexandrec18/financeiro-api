...
INSERT INTO usuario (codigo, nome, email, senha, codigo_empresa) values (1, 'Administrador', 'admin@algamoney.com', '$2a$10$X607ZPhQ4EgGNaYKt3n4SONjIv9zc.VMWdEuhCuba7oLAL5IvcL5.', 1);
INSERT INTO usuario (codigo, nome, email, senha, codigo_empresa) values (2, 'Maria Silva', 'maria@algamoney.com', '$2a$10$Zc3w6HyuPOPXamaMhh.PQOXvDnEsadztbfi6/RyZWJDzimE8WQjaq', 1);
...
INSERT INTO permissao (codigo, descricao) values (16, 'ROLE_REMOVER_CATEGORIA');
